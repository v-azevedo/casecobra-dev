  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        ...
        description:
          "There was an problem saving your config, please try again",
        variant: "destructive",
      });
    }
  }
                        ...
                        {selectableOptions.map((option) => (
                          <RadioGroup.Option
                            ...
                            className={({ focus, checked }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-offset-0 ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",
                                {
