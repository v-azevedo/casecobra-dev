...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
  ...
  if (material === "polycarbonate")
    totalPrice += PRODUCTS_PRICES.materials.polycarbonate;
  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-5 md:gap-x-8 lg:gap-x-12">
              ...
              <div className="flow-root text-sm">
                ...
                {material === "polycarbonate" && (
                  <div className="flex items-center justify-between py-1 mt-2">
                    ...
                    <p className="font-medium text-gray-900">
                      {formatPrice(
                        PRODUCTS_PRICES.materials.polycarbonate / 100
                      )}
                    </p>
                  </div>
                )}
